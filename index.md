...
Further details about how long personal information obtained for research is kept can be found in our [Data Retention Schedule](https://www.ucl.ac.uk/library/about-us/records-office/records-retention).
...
## Cookies
Cookies are files with a small amount of data that are commonly used as anonymous unique identifiers. These are sent to your browser from the websites that you visit and are stored on your device's internal memory. More information can be found in the UCL Cookie Policy [here](https://www.ucl.ac.uk/legal-services/privacy/cookie-policy).
The App does not currently use these “cookies”. 
